            ...
            <div className="container col-xxl-8">
                <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                    <div className="col-10 col-sm-8 col-lg-6">
                        <img src="../images/img/Traveler.png" className="traveler-img d-block mx-lg-auto img-fluid" loading="lazy" alt="Traveler"/>
                    </div>
                    <div className="col-lg-6">
                        <h1 className="display-5 fw-bold lh-1 mb-3" id="title">Get started your exciting<span className="orange-color">journey</span> with us.</h1>
                        <p className="lead">A Team of experienced tourism professionals will provide you with the best advice and tips for your desire place.</p>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg">
                                <div className="card-body row">
                                    ...
                                    <p className="card-text">When you will go</p>
                                </div>
                            </div>
                            <div className="col-lg">
                                <div className="card-body row">
